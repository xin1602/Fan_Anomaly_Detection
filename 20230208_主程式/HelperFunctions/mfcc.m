...
%   Permision to use this code has been granted by the author, per
%   license_mfcc.txt which is included in this directory
%
%   Copyright: Kamil Wojcicki, September 2011
